...
$(function(){
	...
	function setMenu(id){
		if(id=="menu_depart"){
            ...
            $("#content").attr("src",$.util.webName + "/page/user/user.html?sessionId=" + $.util.getSessionId());
		}else if(id=="menu_postion"){
            $("#content").attr("src",$.util.webName + "/page/position/position.html?sessionId=" + $.util.getSessionId());
		}else if(id=="menu_role"){
			$("#content").attr("src",$.util.webName + "/page/role/role.html?sessionId=" + $.util.getSessionId());
		}else if(id=="menu_setting"){
            $("#content").attr("src",$.util.webName + "/page/setting/setting.html?sessionId=" + $.util.getSessionId());
		}
	}
